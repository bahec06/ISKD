...
/* Useful constants                                                 ======== */
/*****************************************************************************/
#define IVI_ENGINE_MAJOR_VERSION        15
...
ViStatus  IviDll _VI_FUNC   Ivi_viWrite (ViSession vi, ViByte buffer[], ViInt32 count, ViInt32 *returnCount);
ViStatus  IviDll _VI_FUNC   Ivi_viRead (ViSession vi, ViInt32 bufferSize, ViByte buffer[], ViInt32 *returnCount);
